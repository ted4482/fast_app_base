...
import 'package:fast_app_base/screen/main/tab/stock/search/w_search_stock_app_bar.dart';
import 'package:fast_app_base/screen/main/tab/stock/search/w_search_stock_history_list.dart';
...
class _SearchStockScreenState extends State<SearchStockScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SearchStockAppBar(controller: controller),
      body: ListView(
        children: const [
